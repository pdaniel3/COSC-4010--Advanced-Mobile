...
public class Controller extends Activity implements Button.OnClickListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        moveBlank = (Button) findViewById(R.id.moveBlank);
        moveBlank.setOnClickListener(this);
...
//        scanButton.setOnClickListener(this);
    ...
    public String randomMessage() {
        ArrayList<String> messages = new ArrayList<String>(Arrays.asList("shot 135", "shot 180", "shot 225", "shot 90", "shot 270", "shot 45",
                "shot 0", "shot 315", "move 1 1", "move 0 1", "move -1 1", "move 1 0", "move -1 0",
